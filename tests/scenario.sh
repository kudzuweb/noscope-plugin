...
{"createUnits":[{"ref":"big","parent":"001-command","type":"base","objective":"Work that is hard to decompose","leader":{"provider":"claude-code","model":"claude-fable-5-1"},"equipment":["Read"],"bashAllowlist":[]}],
