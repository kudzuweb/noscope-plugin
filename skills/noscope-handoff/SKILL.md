...
| 1. Finish nothing new | Do not start a task or call a leader. A seat still running finishes on its own, and its result reaches the record through the hooks whether or not this session is alive. |
